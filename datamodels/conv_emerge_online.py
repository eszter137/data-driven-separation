...
def main():
    ...
    parser.add_argument("-K", "--K", type=int, default=8, help="# of student nodes")
    parser.add_argument(
        "--kernel_size",
        type=int,
        default=50,
    ...
    if args.model == "convolutional":
        ...
        student_desc = args.model + "_ks%d" % args.kernel_size
        if train_bias:
            student_desc += "_bias"
    else:
        ...
        with torch.no_grad():
            for param in student.parameters():
                ...
                if args.l2 > 0:  # l2 weight decay
                    ...
                    param.data -= args.l1 / input_dim * torch.abs(param.data)
